...
type Props = {
  current: RequestParams["type"];
  setFilter: Dispatch<SetStateAction<RequestParams["type"]>>;
}

const TypeFilter = ({ current, setFilter }: Props) => {
  return (
    <div className="grid grid-cols-4 gap-2.5">
      <p className="col-span-full font-light text-sm">Type Filter: </p>
      {allowedValues.type.map(f => (
