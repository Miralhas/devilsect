      ...
      {needsTruncation && (
        <div className="w-full grid pe-4" ref={buttonRef}>
          <button
            ...
            className="bg-primary inline-flex items-center transition-all ease-in-out duration-200 hover:bg-primary/80 px-2 py-1 rounded-md cursor-pointer uppercase font-extrabold tracking-tighter text-[11px] w-fit ms-auto gap-0.5"
          >
