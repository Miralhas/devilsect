...
const UserInbox = () => {
  ...
  return (
    <Link href="/account/inbox" className="transition-transform duration-100 ease-out transform flex items-center gap-2 group hover:scale-[1.03] text-foreground/80 hover:text-foreground group:">
