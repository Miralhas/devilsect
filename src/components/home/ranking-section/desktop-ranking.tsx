...
const DesktopRanking = ({ queries }: DesktopRankingProps<NovelSummary[]>) => {
  return (
    <div className="flex w-full">
      <ScrollArea className="w-32 min-h-0 flex-1 overflow-x-scroll lg:overflow-hidden">
        <div className="w-full grid grid-cols-[repeat(4,minmax(280px,1fr))] grid-rows-[min-content_max-content] gap-x-5 gap-y-7">
