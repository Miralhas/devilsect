...
const NotFound = () => {
  return (
    <div className="h-screen bg-[url(https://wsrv.nl/?url=https%3A%2F%2Fstatic.devilsect.com%2Fdivine-tribulation.jpg&w=3840&q=75&output=webp&fit=cover&dpr=2&maxage=15d&il=true&af=true)] bg-cover bg-bg-no-repeat overlay">
